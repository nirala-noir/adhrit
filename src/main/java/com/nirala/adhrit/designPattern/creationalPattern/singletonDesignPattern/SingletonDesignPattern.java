...
public class SingletonDesignPattern {
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("Singleton Pattern says that just " +
                "define a class that has only one instance and provides a global point of access to it.");
        /*In other words, a class must ensure that
        ...
        *1.static member of class:It gets memory only once because of static, itcontains the instance of the Singleton class.
        ...
        *
        *
        * refernce: https://www.javatpoint.com/singleton-design-pattern-in-java
        * */
